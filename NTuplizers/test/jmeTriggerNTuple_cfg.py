...
listOfPaths = []
#print("check process.paths_()",process.paths_().keys())
...
if opts.inputFiles:
  ...
  process.source.fileNames = [
    '/store/data/Run2024I/Muon1/MINIAOD/PromptReco-v2/000/386/951/00000/dc869840-4435-4cf2-86b5-7e2d79a720b6.root'
    #'/store/data/Run2024I/Muon1/MINIAOD/PromptReco-v2/000/386/951/00000/fc14a5cd-7942-4ff9-b1f1-041f287db2df.root'
...
if opts.secondaryInputFiles:
  ...
  process.source.secondaryFileNames = [
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/1bbbe346-17df-464b-8f12-b73199789741.root',
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/46d3c116-df44-46be-a3ca-e9fd8d21ccc5.root',
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/5fc0faa4-803a-4b70-8ae5-116da4e15de8.root',
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/640046f6-4c9b-4bc4-9bb3-5d7851b9a7d9.root',
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/cbeb8214-17a0-4523-81b1-11fb6d168728.root',
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/dbcd89aa-1e86-4a7b-8120-4ae857db90fe.root',
    '/store/data/Run2024I/Muon1/RAW/v1/000/386/951/00000/f0a74fad-e87a-4733-8e27-e25bb2fa6121.root'
  ]
